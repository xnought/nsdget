...
from .load_data import load_transform, load_sourcedata
...
class NSDmapdata:
    ...
    def fit(
        ...
        tdir = os.path.join(f"{nsd_path}", "ppdata", f"subj{subjix:02d}", "transforms")
        ...
        # apply transform
        transformeddata = transform_data(a1_data, sourcedata, transform_args)
